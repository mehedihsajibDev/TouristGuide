...
public class ShowTravelPackage extends AppCompatActivity {
    private DatabaseReference mDatabase;
    private ProgressBar progressBar;
    private FirebaseAuth.AuthStateListener authListener;
    private FirebaseAuth mAuth;
    private ImageView Post_image;
    private TextView details, title, tourDuration, tourPrice, bestTime, tourAvailable, nextTour, location, number, booking;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_show_travel_package);
        ...
        tourDuration = (TextView) findViewById(R.id.tourDuration);
        tourPrice = (TextView) findViewById(R.id.tourPrice);
        bestTime = (TextView) findViewById(R.id.bestTime);
        tourAvailable = (TextView) findViewById(R.id.tourAvailable);
        nextTour = (TextView) findViewById(R.id.nextTour);
        ...
        mDatabase.child(post_key).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                tourDuration.setText(durationof);
                tourPrice.setText(priceof + " TK");
                bestTime.setText("Best time to go: " + besttimeof);
                location.setText(locationof);
                tourAvailable.setText("Tour Available: " + availableof);
                nextTour.setText("Next scheduled Tour: " + nexttourof);
                number.setText(contactof);

                Picasso.with(ShowTravelPackage.this).load(post_imageof).networkPolicy(NetworkPolicy.OFFLINE).into(Post_image, new Callback() {
                    @Override
                    ...
                    @Override
                    public void onError() {
                        Picasso.with(ShowTravelPackage.this).load(post_imageof).into(Post_image);
        ...
        booking.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ShowTravelPackage.this, BookNow.class);
        ...
        authListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user == null) {
                    startActivity(new Intent(ShowTravelPackage.this, MainActivity.class));
                    finish();
                }
            }
        };
