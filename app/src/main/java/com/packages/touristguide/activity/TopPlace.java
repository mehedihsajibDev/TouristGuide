...
public class TopPlace extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mUser.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                Picasso.with(TopPlace.this).load(pro_pic).networkPolicy(NetworkPolicy.OFFLINE).into(profilepic, new Callback() {
                    @Override
                    ...
                    @Override
                    public void onError() {
                        Picasso.with(TopPlace.this).load(pro_pic).into(profilepic);
        ...
        authListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user == null) {
                    startActivity(new Intent(TopPlace.this, MainActivity.class));
                    finish();
                }
            }
        };
...
//            @Override
//            public void onClick(View view) {
//                Intent intent = new Intent(getApplicationContext(), AddTopPlace.class);
...
//        });
    ...
    public void navigation(){
        ...
        edit_profile.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(TopPlace.this, EditProfile.class);
                startActivity(intent);
            }
        });
        ...
        profilepic.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(TopPlace.this, "Profile Picture", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (drawer.isDrawerOpen(GravityCompat.START)) {
                    drawer.closeDrawer(GravityCompat.START);
                    Intent intent = new Intent(TopPlace.this, Home.class);
                    startActivity(intent);
                }
            }
        });
        ...
        travell.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (drawer.isDrawerOpen(GravityCompat.START)) {
                    drawer.closeDrawer(GravityCompat.START);
                    Intent intent = new Intent(TopPlace.this, TravellingPackage.class);
                    startActivity(intent);
                } else {
        ...
        forum.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (drawer.isDrawerOpen(GravityCompat.START)) {
                    drawer.closeDrawer(GravityCompat.START);
                    Intent intent = new Intent(TopPlace.this, Forum.class);
                    startActivity(intent);
                } else {
...
//                if (drawer.isDrawerOpen(GravityCompat.START)) {
//                    drawer.closeDrawer(GravityCompat.START);
//                    Intent intent = new Intent(TopPlace.this, Conversation.class);
//                    startActivity(intent);
//                } else {
//
//                }
...
//        });
    ...
    public void onStart() {
        ...
        FirebaseRecyclerAdapter<TopplaceModel, TopPlace.ViewHolder> firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<TopplaceModel,
                TopPlace.ViewHolder>(TopplaceModel.class, R.layout.top_places, TopPlace.ViewHolder.class, mDatabase) {
            @Override
            protected void populateViewHolder(TopPlace.ViewHolder viewHolder, final TopplaceModel model, int position) {
                ...
                viewHolder.mView.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        Intent intent = new Intent(getApplicationContext(), ShowTopPlaceDetails.class);
